...
static void Gimbal_Limit(void)
{
    ...
    PATROL_YAW_MAX_ANGLE = 80;//364
    PATROL_YAW_ZERO_POS =  0;
    PATROL_YAW_MIN_ANGLE =-80;//-36;
}
...
static void PID_Gimbal_Init(void)
{
    ...
    MotoPitch.PidSpeed.P = -6500.0f;//-8000.0f;
...
//    MotoPitch.PidPosV.IMax = 1200.0f;
    ...
    MotoPitch.PidPosV.P = -280.0f;//-100.0f;//-200.0f;
    MotoPitch.PidPosV.I = -2.8f;//-3.0f;//-1.5f;//-0.25f;
    MotoPitch.PidPosV.D = 0.0f;//-2.0f; //1800.0f;
    MotoPitch.PidPosV.IMax = 200.0f;//300.0f; //50.0f;
