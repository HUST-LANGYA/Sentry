...
void Down_CAN1Send(void)
{
   ...
   //extern uint8_t Send_Up_buffer[Send_Up_Size];
	 ...
	 CAN1_tx_message_remote.RTR = CAN_RTR_DATA;
	 CAN1_tx_message_remote.DLC = 0x08;
	 CAN1_tx_message_remote.StdId = GIMBAL_DOWN_ID;
	 
	 CAN1_tx_message_remote.Data[0] = (uint8_t)(send_pitch >> 8 & 0x00FF);
	 CAN1_tx_message_remote.Data[1] = (uint8_t)(send_pitch & 0x00FF);
	 CAN1_tx_message_remote.Data[2] = (uint8_t)(send_yaw >> 24 & 0x000000FF);
	 CAN1_tx_message_remote.Data[3] = (uint8_t)(send_yaw >> 16 & 0x000000FF);
	 CAN1_tx_message_remote.Data[4] = (uint8_t)(send_yaw >> 8 & 0x000000FF);
	 CAN1_tx_message_remote.Data[5] = (uint8_t)(send_yaw & 0x000000FF);
	 CAN1_tx_message_remote.Data[6] = (uint8_t)(last_armor_state==ARMOR_NO_AIM && armor_state == ARMOR_AIMED);//瞄准状态上升沿时数据数据才是有效的
