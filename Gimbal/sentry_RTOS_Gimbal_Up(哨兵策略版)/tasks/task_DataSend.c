...
void Down_CAN2Send(void)
{
   ...
   extern uint8_t Send_Dn_buffer[Send_Dn_Size];
	 ...
	 CAN2_tx_message_remote.RTR = CAN_RTR_DATA;
	 CAN2_tx_message_remote.DLC = 0x08;
	 CAN2_tx_message_remote.StdId = GIMBAL_UP_ID;
	 
	 CAN2_tx_message_remote.Data[0] = (uint8_t)(send_pitch >> 8 & 0x00FF);
	 CAN2_tx_message_remote.Data[1] = (uint8_t)(send_pitch & 0x00FF);
	 CAN2_tx_message_remote.Data[2] = (uint8_t)(send_yaw >> 24 & 0x000000FF);
	 CAN2_tx_message_remote.Data[3] = (uint8_t)(send_yaw >> 16 & 0x000000FF);
	 CAN2_tx_message_remote.Data[4] = (uint8_t)(send_yaw >> 8 & 0x000000FF);
	 CAN2_tx_message_remote.Data[5] = (uint8_t)(send_yaw & 0x000000FF);
	 CAN2_tx_message_remote.Data[6] = (uint8_t)(last_armor_state==ARMOR_NO_AIM && armor_state == ARMOR_AIMED);//瞄准状态上升沿时数据数据才是有效的
	
	 CAN_Transmit(CAN1, &CAN2_tx_message_remote);
//	 Send_Dn_buffer[0] = '!';
//	 Send_Dn_buffer[1] = (unsigned char)(send_pitch >> 8 & 0x00FF);
//   Send_Dn_buffer[2] = (unsigned char) (send_pitch & 0x00FF);
//	
//	 Send_Dn_buffer[3] = (unsigned char)(send_yaw >> 24 & 0x000000FF);
//	 Send_Dn_buffer[4] = (unsigned char)(send_yaw >> 16 & 0x000000FF);
//	 Send_Dn_buffer[5] = (unsigned char)(send_yaw >> 8 & 0x000000FF);
//	 Send_Dn_buffer[6] = (unsigned char)(send_yaw >> 0 & 0x000000FF);
//	 Send_Dn_buffer[7] = (unsigned char) (last_armor_state==ARMOR_NO_AIM && armor_state == ARMOR_AIMED);//瞄准状态上升沿
//	 last_armor_state = armor_state;
//   Append_CRC8_Check_Sum(Send_Dn_buffer, Send_Dn_Size);
