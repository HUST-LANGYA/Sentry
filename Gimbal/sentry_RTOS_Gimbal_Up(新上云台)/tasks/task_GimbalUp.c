...
static void Gimbal_PC_Act(void)
{
    ...
    else
    {
        ...
        extern  short tx2_receive_flag;
			  ...
			  //tx2_receive_flag = (uint8_t)(PCbuffer[1]&0xff);         //作为更新标志位
...
//            MotoYaw.PidPosV.SetPoint   = aim_yaw;
        ...
        {   
   					extern float aim_Up_Pitch;//下云台发来的Pitch协同值
            extern float aim_Up_Yaw;//下云台发来的Yaw协同值
...
{
    PITCH_MAX_ANGLE =+20.0f; //尽量不要打太远，会被对面的高地挡住
    PITCH_ZERO_POS = +0;
