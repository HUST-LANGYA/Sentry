...
void task_ActionUpdate(void)
{
    ...
    //Sentry_State.Gimbal_Dn_Mode=Gimbal_Dn_RC;
	  //Sentry_State.Shoot_Dn_Mode = Shoot_Dn_RC;
	   Sentry_State.Shoot_Dn_Mode = Shoot_Dn_RC;
...
//        {
//            chassis_offline_flag = 1; //标志底盘掉电
//            Heat_ShootAbleFlag_2 = 1; //强行给射击标志置位
//            //执行底盘掉电时的射击和云台模式调度
    ...
    case 1:
        ...
        case 1: //正式上轨运行模式，比赛用
            sentry_state_reflect(Gimbal_Up_PC,
                                 Gimbal_Dn_PC,
                                 Shoot_Up_SLEEP,//Shoot_Up_PC,
                                 Shoot_Dn_SLEEP,//Shoot_Dn_PC,
                                 Chassis_Patrol);
            break;
        case 2:
