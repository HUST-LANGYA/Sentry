...
int16_t FrictionMotor_Right_Speed;
int16_t FrictionMotor_Left_Speed;
...
//  accelerator1 = LIMIT_MAX_MIN(tmpAccelerator1, 900, 400);
  ...
  float fsend;
  // 调试记录
	FrictionMotor_Left_Speed = FrictionMotor[0].RealSpeed;
	FrictionMotor_Right_Speed = -FrictionMotor[1].RealSpeed;
	 // 增量式控制
