...
int16_t BulletHeat17_0 = 10;
int16_t BulletHeat17_2 = 10;

int32_t CurHeat17_0, LastHeat17_0, AvailableHeat17_0;
int32_t CurHeat17_2, LastHeat17_2, AvailableHeat17_2; //当前热量， 上一次热量, 自行计算热量

int32_t Shooted17Cnt_0,Shooted17Cnt_2 ;//一周期内已打出子弹数
int32_t AvailableBullet17_0,AvailableBullet17_2;	//下一周期允许打弹数

uint8_t ShootAbleFlag_0,ShootAbleFlag_2;
...
static void HeatControl_0(void)
{
	if(HeatUpdateFlag_0 == 1)	//热量更新
	{
		...
		ShootAbleFlag_0 = (AvailableBullet17_0 < 17)?0:1;		
	}	
	...
	else if((ShootCpltFlag_0 == 1) && (HeatUpdateFlag_0 == 0))	//热量没有更新，但检测到发弹
	{
		...
		ShootAbleFlag_0 = (Shooted17Cnt_0 >= AvailableBullet17_0-17)?0:1;		
	}
}

static void HeatControl_2(void)
{
	if(HeatUpdateFlag_2 == 1)	//热量更新
	{
		...
		ShootAbleFlag_2 = (AvailableBullet17_2 < 10)?0:1;		
	}	
	...
	else if((ShootCpltFlag_2 == 1) && (HeatUpdateFlag_2 == 0))	//热量没有更新，但检测到发弹
	{
		...
		ShootAbleFlag_2 = (Shooted17Cnt_2 >= AvailableBullet17_2-10)?0:1;		
	}
}
...
*返 回 值: 无
**********************************************************************************************************/
float HeatControlThreshold_0 = 0.5f;   	//开启热量控制的阈值
float HeatControlThreshold_2 = 0.27f;   	//开启热量控制的阈值

void HeatUpdate_0(void)
{
    HeatMax17_0 = JudgeReceive.HeatMax17_0;
    HeatCool17_0 = (JudgeReceive.HeatCool17_0) / 10;
