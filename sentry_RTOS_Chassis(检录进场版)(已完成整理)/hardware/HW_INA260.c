...
static int16_t INA260_Read(uint8_t address, uint8_t reg);
//static void INA260_WriteOneByte(uint8_t address,u8 reg,uint8_t command);
...
//static void INA260_WriteOneByte(uint8_t address,uint8_t reg,uint8_t command)
//{ 
//    IIC_Start();
