...
//		block_disconnect.Chassis_Last_Cnt = GetSysCnt();
	...
	// 接收减速轮的数据
	else if(Can1_rx_message_0.StdId == motor_gearbox_ID)
	{
	      motor_gearbox.angle_abs = Can1_rx_message_0.Data[0] << 8  | Can1_rx_message_0.Data[1];
		    motor_gearbox.real_speed = Can1_rx_message_0.Data[2] << 8 | Can1_rx_message_0.Data[3];
		    motor_gearbox.real_flow = Can1_rx_message_0.Data[4] << 8  | Can1_rx_message_0.Data[5];
	}
...
//	 if (Can2_rx_message_0.StdId == MOTOR_CHASSIS_ID) //底盘电机的ID号
//	{
////        extern _3508_motor_t motor_chassis;
////		    extern _2006_motor_t motor_gearbox;
////		block_disconnect.Chassis_Last_Cnt = GetSysCnt();
//				motor_chassis.angle_abs  = Can2_rx_message_0.Data[0] << 8 | Can2_rx_message_0.Data[1];
//				motor_chassis.real_speed = Can2_rx_message_0.Data[2] << 8 | Can2_rx_message_0.Data[3];
//        motor_chassis.real_flow  = Can2_rx_message_0.Data[4] << 8 | Can2_rx_message_0.Data[5];
//	}    
//	else if(Can2_rx_message_0.StdId == motor_gearbox_ID)
//	{
//	      motor_gearbox.angle_abs = Can2_rx_message_0.Data[0] << 8  | Can2_rx_message_0.Data[1];
//		    motor_gearbox.real_speed = Can2_rx_message_0.Data[2] << 8 | Can2_rx_message_0.Data[3];
//		    motor_gearbox.real_flow = Can2_rx_message_0.Data[4] << 8  | Can2_rx_message_0.Data[5];
//	}
...
{
	 if (Can2_rx_message_1.StdId == MOTOR_CHASSIS_ID) //底盘电机的ID号
	{
//        extern _3508_motor_t motor_chassis;
//		    extern _2006_motor_t motor_gearbox;
//		block_disconnect.Chassis_Last_Cnt = GetSysCnt();
				motor_chassis.angle_abs  = Can2_rx_message_1.Data[0] << 8 | Can2_rx_message_1.Data[1];
				motor_chassis.real_speed = Can2_rx_message_1.Data[2] << 8 | Can2_rx_message_1.Data[3];
        motor_chassis.real_flow  = Can2_rx_message_1.Data[4] << 8 | Can2_rx_message_1.Data[5];
	}    
	else if(Can2_rx_message_1.StdId == motor_gearbox_ID)
	{
	      motor_gearbox.angle_abs = Can2_rx_message_1.Data[0] << 8  | Can2_rx_message_1.Data[1];
		    motor_gearbox.real_speed = Can2_rx_message_1.Data[2] << 8 | Can2_rx_message_1.Data[3];
		    motor_gearbox.real_flow = Can2_rx_message_1.Data[4] << 8  | Can2_rx_message_1.Data[5];
	}
}
