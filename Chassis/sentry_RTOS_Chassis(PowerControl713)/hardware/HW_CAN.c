...
void CAN1_Configuration(void)
{
    ...
    canFilterInit.CAN_FilterScale = CAN_FilterScale_16bit; // 32位过滤器
    canFilterInit.CAN_FilterIdHigh = 0x401 << 5;           // 过滤器标识符
    canFilterInit.CAN_FilterIdLow = 0x402 << 5;
    canFilterInit.CAN_FilterMaskIdHigh = 0x403 << 5; // 过滤器屏蔽标识符
    canFilterInit.CAN_FilterMaskIdLow = 0x404 << 5;
