...
#define LimitSw_R GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_3)   //左行程开关的读数
#define LimitSw_L GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)  //右行程开关的读数
...
#define LimitSw_R_Idle  0   //低电平表示空闲
#define LimitSw_R_Active   1   //高电平表示触发（￣︶￣）↗　
