...
void ShootingHeat_CAN2Send(void)
{
  ...
  tx_message.Data[5] = (uint8_t)(motor_chassis.real_speed>>8 & 0xff);
  tx_message.Data[6] = (uint8_t)(motor_chassis.real_speed & 0xff);
  tx_message.Data[7] = 00;

  CAN_Transmit(CAN2, &tx_message);
}

int Bullet_Speed_100;
void BulletSpeed_CAN2Send(void)
{
  ...
  extern tGameInfo JudgeReceive;
	Bullet_Speed_100 = (int)(JudgeReceive.bulletSpeed * 100);
  tx_message.Data[0] = (uint8_t)( (Bullet_Speed_100 >> 24) & 0x000000FF);
  tx_message.Data[1] = (uint8_t)( (Bullet_Speed_100 >> 16) & 0x000000FF);
  tx_message.Data[2] = (uint8_t)( (Bullet_Speed_100 >> 8) & 0x000000FF);  
  tx_message.Data[3] = (uint8_t)( (Bullet_Speed_100 >> 0) & 0x000000FF);
  tx_message.Data[4] = 0;
  tx_message.Data[5] = 0;
  tx_message.Data[6] = 0;
  tx_message.Data[7] = 00;
...
//void ChassisSpeed_CAN2Send(void)
//{
//  CanTxMsg tx_message_Speed;
//	tx_message_Speed.IDE = CAN_ID_STD;
//	tx_message_Speed.RTR = CAN_RTR_DATA;
//	tx_message_Speed.DLC = 0x08;
//	tx_message_Speed.StdId = CHASSIS_SPEED_ID;
//	
//	extern _3508_motor_t motor_chassis;
//	tx_message_Speed.Data[0] = (uint8_t)(motor_chassis.real_speed>>8 & 0xff);
//	tx_message_Speed.Data[1] = (uint8_t)(motor_chassis.real_speed & 0xff);
//	tx_message_Speed.Data[2] = 0;
//	tx_message_Speed.Data[3] = 0;
//	tx_message_Speed.Data[4] = 0;
//  tx_message_Speed.Data[5] = 0;
//	tx_message_Speed.Data[6] = 0;
//	tx_message_Speed.Data[7] = 0;
//	
//	CAN_Transmit(CAN2,&tx_message_Speed);
