...
#define task_FtirRead_PRIO 30
#define task_FtirRead_SIZE 512
TaskHandle_t task_FtirRead_Handler;
...
//        
    //读取光电开关状态的任务
    xTaskCreate((TaskFunction_t)task_FtirRead,
        (const char*)"task_FtirRead",
        (uint16_t)task_FtirRead_SIZE,
        (void*)NULL,
        (UBaseType_t)task_FtirRead_PRIO,
        (TaskHandle_t*)&task_FtirRead_Handler);
