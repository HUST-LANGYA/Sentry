...
void CAN1_DataReceive_1(void)
{
  ...
  if (Can1_rx_message_1.StdId == Remote_Control_ID) //接收从上云台传来的遥控器数据帧
  {
    RC_Ctl.rc.s1 = ((int8_t)Can1_rx_message_1.Data[5] >> 2) & 0x03;
    RC_Ctl.rc.s2 = ((int8_t)Can1_rx_message_1.Data[5]) & 0x03;
    if (RC_Ctl.rc.s2 == 0 || RC_Ctl.rc.s1 == 0)
      return; //如果传过来空的包就直接丢掉
    RC_Ctl.rc.ch0 = ((int16_t)Can1_rx_message_1.Data[0] << 3 | (int16_t)Can1_rx_message_1.Data[1] >> 5) & 0x7ff;
    RC_Ctl.rc.ch1 = ((int16_t)Can1_rx_message_1.Data[1] << 6 | (int16_t)Can1_rx_message_1.Data[2] >> 2) & 0x7ff;
    RC_Ctl.rc.ch2 = ((int16_t)Can1_rx_message_1.Data[2] << 9 | (int16_t)Can1_rx_message_1.Data[3] << 1 | (int16_t)Can1_rx_message_1.Data[4] >> 7) & 0x7ff;
    RC_Ctl.rc.ch3 = ((int16_t)Can1_rx_message_1.Data[4] << 4 | (int16_t)Can1_rx_message_1.Data[5] >> 4) & 0x7ff;
  }
}
