...
static void PID_Shoot_Init(void)
{
    ...
    FrictionMotor[0].pid_speed.P = 27.0f;
    FrictionMotor[0].pid_speed.I = 0.0f;
    FrictionMotor[0].pid_speed.D = 0.0f;
    FrictionMotor[0].pid_speed.IMax = 0;
    ...
    FrictionMotor[1].pid_speed.P = 27.0f;
    FrictionMotor[1].pid_speed.I = 0.0f;
    FrictionMotor[1].pid_speed.D = 0.0f;
    FrictionMotor[1].pid_speed.IMax = 0;
