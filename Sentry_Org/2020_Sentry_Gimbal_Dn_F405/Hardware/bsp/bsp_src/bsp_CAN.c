...
void CAN1_Configration(void)
{
    ...
    canFilterInit.CAN_FilterNumber = 0;                   //选择过滤器0
	...
	canFilterInit.CAN_FilterFIFOAssignment = 0;//fifo
    ...
    canFilterInit.CAN_FilterMaskIdHigh = Remote_Control_ID << 5;
    canFilterInit.CAN_FilterMaskIdLow = 0 | CAN_ID_STD;
    canFilterInit.CAN_FilterFIFOAssignment = CAN_FilterFIFO1; //fifo
    canFilterInit.CAN_FilterActivation = ENABLE;
    CAN_FilterInit(&canFilterInit);
    delay_ms(100);
...
void CAN2_Configration(void)
{
    ...
    canFilterInit.CAN_FilterScale = CAN_FilterScale_32bit;
    canFilterInit.CAN_FilterIdHigh = 0x207 << 5;
    canFilterInit.CAN_FilterIdLow = 0 | CAN_ID_STD;
    canFilterInit.CAN_FilterMaskIdHigh = 0x205 << 5;
    canFilterInit.CAN_FilterMaskIdLow = 0 | CAN_ID_STD;
    canFilterInit.CAN_FilterFIFOAssignment = CAN_Filter_FIFO0; //fifo0
    canFilterInit.CAN_FilterActivation = ENABLE;
    CAN_FilterInit(&canFilterInit);
    ...
    canFilterInit.CAN_FilterMaskIdLow = 0 | CAN_ID_STD;
    canFilterInit.CAN_FilterFIFOAssignment = CAN_Filter_FIFO1; //fifo1
    canFilterInit.CAN_FilterActivation = ENABLE;
    CAN_FilterInit(&canFilterInit);
    //CAN中断配置
