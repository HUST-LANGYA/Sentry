...
//  GPIO_InitStructure.GPIO_Pin=GPIO_Pin_8|GPIO_Pin_9;      //PC8 Tim8--Ch3     PC9 Tim8--Ch4
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_6|GPIO_Pin_7;      //PC8 Tim8--Ch1     PC9 Tim8--Ch2
...
//	GPIO_PinAFConfig(GPIOC,GPIO_PinSource9,GPIO_AF_TIM8);   //用引脚PC9；把TIM8引到AF3
    ...
    GPIO_PinAFConfig(GPIOC,GPIO_PinSource6,GPIO_AF_TIM8);   //用引脚PC6；把TIM8引到AF3
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource7,GPIO_AF_TIM8);   //用引脚PC7；把TIM8引到AF3
...
//		TIM_SetCompare4(TIM8,0);                                                //手动重设写到CCR里的装载值（写零复位）
        TIM_SetCompare1(TIM8,0);                                                //手动重设写到CCR里的装载值（写零复位）
		TIM_SetCompare2(TIM8,0);                                               //手动重设写到CCR里的装载值（写零复位）
