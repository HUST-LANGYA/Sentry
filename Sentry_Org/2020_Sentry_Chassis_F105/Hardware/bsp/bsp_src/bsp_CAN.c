...
//	GPIO_PinRemapConfig(GPIO_Remap1_CAN1,ENABLE);  // CAN1 remap
	...
	canFilterInit.CAN_FilterIdHigh=MOTOR_CHASSIS_ID << 5;			// 过滤器标识符
	canFilterInit.CAN_FilterIdLow=0 | CAN_ID_STD;				
	canFilterInit.CAN_FilterMaskIdHigh= 0x202 << 5;		// 过滤器屏蔽标识符
	...
	canFilterInit.CAN_FilterScale=CAN_FilterScale_16bit;   // 32位过滤器
	canFilterInit.CAN_FilterIdHigh=BodanMotor_Up_ID << 5;	// 过滤器标识符
	canFilterInit.CAN_FilterIdLow=0 | CAN_ID_STD;				
	canFilterInit.CAN_FilterMaskIdHigh=0x204 << 5;		// 过滤器屏蔽标识符
	canFilterInit.CAN_FilterMaskIdLow=0 | CAN_ID_STD;
...
void CAN2_Configuration(void)
{
	...
	canFilterInit.CAN_FilterNumber=14;	// 
	canFilterInit.CAN_FilterMode=CAN_FilterMode_IdList;	 // 标识符屏蔽位模式
	canFilterInit.CAN_FilterScale=CAN_FilterScale_16bit;   // 32位过滤器
	canFilterInit.CAN_FilterIdHigh=Remote_Control_ID<<5;			// 过滤器标识符
	canFilterInit.CAN_FilterIdLow=0x0000;//0 | CAN_ID_STD;				
	canFilterInit.CAN_FilterMaskIdHigh=0x0000;//0| CAN_ID_STD;		// 过滤器屏蔽标识符
	canFilterInit.CAN_FilterMaskIdLow=0x0000;//0 | CAN_ID_STD;
	canFilterInit.CAN_FilterFIFOAssignment=CAN_FIFO0;	 // FIFO1指向过滤器
	canFilterInit.CAN_FilterActivation=ENABLE;
	CAN_FilterInit(&canFilterInit);
